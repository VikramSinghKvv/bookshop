...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("BorrowingsObjectPageObjectPage journey");

        opaTest("Navigate to BorrowingsObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheBooksObjectPage.onTable({ property: "borrowings" }).iCheckRows();
            When.onTheBooksObjectPage.onTable({ property: "borrowings" }).iPressRow(0);

            Then.onTheBorrowingsObjectPage.iSeeThisPage();
        });
